...
/* Assets that must never reach the screen, whatever the API returns. The BE excludes SPCXX at
   source now, so this is a guard rather than the mechanism. Not a hard-coded stock
